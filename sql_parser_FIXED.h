...
struct Literal : public Expression {
    std::string value;
    TokenType type;
    Literal(const std::string& v, TokenType t) : value(v), type(t) {}
};
...
struct BinaryOp : public Expression {
    ...
    TokenType op;
    BinaryOp(std::shared_ptr<Expression> l, std::shared_ptr<Expression> r, TokenType o)
        : left(l), right(r), op(o) {}
};
...
struct UnaryOp : public Expression {
    ...
    TokenType op;
    UnaryOp(std::shared_ptr<Expression> o, TokenType op_type)
        : operand(o), op(op_type) {}
};
...
struct InsertStmt : public ASTNode {
    std::string table_name;
    std::vector<std::string> columns;  // explicit column list (optional)
